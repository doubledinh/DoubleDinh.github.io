...
Out of all the colleges labeled as not non profit, we correctly predicted 3525 colleges and incorrectly predicted 310. By contrast, out of all the colleges labeled as for profit, we correctly identified 2671, and incorrectly predicted 234.

I then ran a gradient boosting model and two new classifying models called RandomForestClassifier and Support vector machines. Yet, in order to determine the best model to use, I created an ROC curve and found that the most accurate model was the gradient boosting model with an AUC value of 98.48%. 

Lastly, I created an algorithm that would rank the worst colleges in the dataset. I first selected the categories that I wanted to sort the colleges by. I picked: loan principal, % of students with loans, % of students with their 7 year repayment completed, 5 year declining balance, and the colleges' retention rate. However, before I could rank them, I had to transform the seven year repayment category in order to display the % of students that had not repaid the college since I am scoring the colleges based on how bad they are. I also had to the same to the 5 year declining balance in order to select the % of students who, after five years, could not lower their debt balance. From there, I scaled the categories accordingly and added the colleges' scores up. According to my algorithm, I found that the top 10 worst colleges were: Stevens-Henager College, Beulah Heights University, Sanford-Brown College, National College, Virginia College, CollegeAmerica, Lane College, Kenneth Shuler School of Cosmetology, and Allen University. Upon further research, I found that some of these colleges are now closed because of a lawsuit filed against them. For instance, Sanford Brown Colleges were closed due to a class-action lawsuit filed by former students. In fact, according to [the New York Times](https://www.nytimes.com/2019/01/03/business/student-debt-career-education-corporation.html), the parent company of Sanford Brown, Career Education, misled students about the cost of its programs and its graduates’ job prospects. Furthermore, in some cases, Career Education charged students for vocational programs that lacked the accreditation needed for them to obtain a license and work in their field. Predatory colleges have been on the watchlist for the past decade. According to [Big Think](https://bigthink.com/politics-current-affairs/predatory-student-loans?rebelltitem=3#rebelltitem3), there are plenty of schools that hand out practically worthless degrees. 

When I researched into colleges that were predatory, I found that the most common characteristics between the colleges were their high student debt. At times, the student debt would reach a value that the students could never repay. In the case of our dataset, the categorical variable that we should look at is the percentage of students that successfully repays the college after 7 years. Moreover, I would look at the percentage of students with student loans and compare that to the loan principal. If the college has a high percentage of students currently in debt via student loans, has a high loan principal, and has a low percentage of students that successfully repays the college after 7 years, I would classify that college as predatory.
